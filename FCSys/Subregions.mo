...
package Subregions "Control volumes with multi-species transfer and storage"
  ...
  model Subregion "Subregion with all phases"
    ...
    Phases.ExchangeParams common(k_Phi={0.6,0.6,0.6}) "Among all phases"
  ...
  equation
    ...
    connect(liquid.inter[1], exchCommon.node) annotation (Line(
        points={{-65,-7},{-65,42},{86,42}},
        color={221,23,47},
        smooth=Smooth.None));
    // Gas-graphite
    connect(gas.inter[2], exchGasGraphite.node) annotation (Line(
        points={{-25,-7.5},{-25,54},{86,54}},
        color={221,23,47},
        smooth=Smooth.None));
    connect(graphite.inter[2], exchGasGraphite.node) annotation (Line(
        points={{15,-7.5},{15,54},{86,54}},
        color={221,23,47},
        smooth=Smooth.None));
    ...
    connect(HOR.inert, graphite.inter[1]) annotation (Line(
        points={{88.2,-20},{16,-20},{16,-6.5},{15,-6.5}},
        color={127,127,127},
        smooth=Smooth.None));
