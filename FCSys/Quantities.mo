...
<code>unit</code> attribute of each quantity is used to denote the
  ...
  <a href=\"modelica://FCSys.Quantities.Temperature\">Temperature</a> is an alias for
...
(e.g., <code>min=0</code> for <a href=\"modelica://FCSys.Quantities.PressureAbsolute\">PressureAbsolute</a>).</p>

  <p>This  package (<a href=\"modelica://FCSys.Quantities\">Quantities</a>) is abbreviated as <code>Q</code> throughout
  the rest of <a href=\"modelica://FCSys.FCSys\">FCSys</a>.
...
<p>For more information, please see the
  documentation of the <a href=\"modelica://FCSys.Units\">Units</a> package.</p>
