...
for s in Acceleration Amount AmountReciprocal Angle Angle2 Area AreaSpecific Capacitance ConcentrationRate ConductanceElectrical ConductivityElectrical Continuity Current CurrentAreic CurrentAreicAbsolute CurrentRate Density Diffusivity DiffusivityMassSpecific Energy Fluidity Force ForceSpecific Frequency Inductance Length LengthReciprocal LengthSpecific MagneticFlux MagneticFluxAreic MagneticFluxReciprocal Mass MassRate MassSpecific MassVolumic Mobility MomentumRotational Number NumberAbsolute Permeability Permittivity PermittivityReciprocal Potential PotentialAbsolute PotentialPerWavenumber PotentialRate Power PowerArea PowerAreic PowerAreicPerPotential4 PowerRadiant Pressure PressureAbsolute PressureRate PressureReciprocal ResistanceElectrical ResistanceFluid ResistanceThermal Resistivity SurfaceTension Time TimeAbsolute TimeLineic Velocity Velocity2 
do
